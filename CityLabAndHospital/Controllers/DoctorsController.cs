...
namespace CityLabAndHospital.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(citylabDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,DoctorName,Qualification,Address,Mobile")] Doctors doctors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,DoctorName,Qualification,Address,Mobile")] Doctors doctors)
        {
